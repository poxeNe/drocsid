...
export const mkNewCharacter = async () => {
    ...
    const possibleProfessions = ["Warrior", "warrior", "Thief", "thief", "Mage", "mage"];

    while (!possibleProfessions.includes(profession)) {
    ...
    const player = new Character(name, profession as Profession);
